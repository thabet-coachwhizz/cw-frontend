...
export default function ChallengeDetail({ challenge }: Props) {
  ...
  return (
    <>
      ...
      >
        <div className="mt-4">
          <ChallengeAccordion title="Main Challenge" className="p-5 bg-[#333546] rounded-2xl">
            <div className="text-xl font-semibold mt-3 mb-2">{challenge.main_task_name}</div>
        ...
        <div className="mt-4">
          <ChallengeAccordion title="Reframe Your Mindset" className="p-5 bg-[#333546] rounded-2xl">
            <p className="text-[#BBBBc0] mt-3">{challenge.soft_skill_mindset}</p>
          </ChallengeAccordion>
        </div>
        <div className="mt-4">
          <ChallengeAccordion title="Observe & Identify" className="p-5 bg-[#333546] rounded-2xl">
      ...
      {/* 🟩 Box 4: Review Input */}
      <ChallengeAccordion title="Review your input" className="p-5 bg-[#BDC8F208] rounded-3xl">
        <div className="mt-4">
          <ChallengeAccordion title="Detailed description" className="p-5 bg-[#333546] rounded-2xl">
        ...
        <div className="mt-4">
          <ChallengeAccordion title="What Have You Tried?" className="p-5 bg-[#333546] rounded-2xl">
            <p className="text-[#BBBBc0] mt-3">{challenge.attempts}</p>
          </ChallengeAccordion>
        </div>
        <div className="mt-4">
          <ChallengeAccordion title="Desired Outcome?" className="p-5 bg-[#333546] rounded-2xl">
